...
public class MeasurementPercentageMapper {
    ...
    public MeasurementDto toPercentageData(Measurement measurement) {
        return MeasurementDto.builder()
                ...
                .lightIntensity(mapDataToPercentage(BigDecimal.ZERO, BigDecimal.valueOf(40000), measurement.getLightIntensity()))
                ...
                .airPurity(mapDataToPercentage(BigDecimal.valueOf(50), BigDecimal.valueOf(2000), measurement.getAirPurity()))
                .build();
    }
